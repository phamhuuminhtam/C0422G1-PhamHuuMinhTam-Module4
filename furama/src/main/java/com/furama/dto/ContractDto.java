...
@NamedNativeQuery(
        name = "showTotal",
        query =
                "select hop_dong.ma_hop_dong,dich_vu.ten_dich_vu, khach_hang.ho_ten, hop_dong.ngay_lam_hop_dong,hop_dong.ngay_ket_thuc,hop_dong.tien_dat_coc, CASE\n" +
...
@SqlResultSetMapping(
        ...
        classes = @ConstructorResult(
                ...
                columns = {
                        ...
                        @ColumnResult(name = "ten_dich_vu", type = String.class),
                        @ColumnResult(name = "ho_ten", type = String.class),
